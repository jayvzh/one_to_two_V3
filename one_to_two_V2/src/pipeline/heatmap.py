...
from ..model.trainer import ModelMeta, OneToTwoPredictor
from .config import load_pipeline_defaults
from .report import generate_heatmap_html
...
def main() -> None:
    ...
    if resolved_model_path is None and defaults.heatmap.model_filename:
        resolved_model_path = str(base_dir / "data" / "models" / defaults.heatmap.model_filename)
    ...
    if args.output:
        ...
        heatmap_cache_dir = base_dir / "data" / "cache" / "heatmap"
        heatmap_cache_dir.mkdir(parents=True, exist_ok=True)
